class AddProjectDescriptionInfoModel {
  bool? status;
  String? message;
  Data? data;

  AddProjectDescriptionInfoModel({this.status, this.message, this.data});

  AddProjectDescriptionInfoModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
